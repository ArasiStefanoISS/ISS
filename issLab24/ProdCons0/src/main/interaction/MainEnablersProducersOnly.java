...
public static final String host    = /*"localhost";*/"130.136.113.239";
...
public void configureTheSystem()  {
    ...
    ProducerUsingConnection producer1 = new ProducerUsingConnection("arasi_stefano", host, port,protocol );
